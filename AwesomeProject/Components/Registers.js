...
import { SafeAreaView, ScrollView, View, StyleSheet, TouchableOpacity, Text, TextInput, Image } from 'react-native'
...
const Registers = () => {
 ...
 <LinearGradient colors={[themeColors.bg, themeColors.bg, '#79155B']} style={{position: 'absolute',
    left: 0,
    right: 0,
    top: 0,
    height: 300,}}/>
      <Image source={require("../assets/myimage.jpg")} style={{
        position: 'absolute', alignSelf: 'center', top: 50, borderRadius: 50, height: 60,
        width: 60, padding: 50
      }} />

      <ScrollView style={{ backgroundColor: "#fff", top: 190, flex: 1,borderTopLeftRadius:20,borderTopRightRadius:20 }}>
  ...
  paddingBottom:60
          ...
          <View style={{
            padding: 50, borderRadius: 15, opacity: 0.9,
            backgroundColor: '#fff',
            shadowColor: "#FC345C",
            shadowOffset: {
              width: 0,
